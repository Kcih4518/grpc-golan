...
type GreetServiceClient interface {
	Greet(ctx context.Context, in *GreetRequeset, opts ...grpc.CallOption) (*GreetResponse, error)
	GreetManyTimes(ctx context.Context, in *GreetRequeset, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error)
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequeset, opts ...grpc.CallOption) (*GreetResponse, error) {
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetRequeset, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
...
func (x *greetServiceLongGreetClient) Send(m *GreetRequeset) error {
...
func (x *greetServiceGreetEveryoneClient) Send(m *GreetRequeset) error {
	return x.ClientStream.SendMsg(m)
}
...
type GreetServiceServer interface {
	Greet(context.Context, *GreetRequeset) (*GreetResponse, error)
	GreetManyTimes(*GreetRequeset, GreetService_GreetManyTimesServer) error
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetRequeset) (*GreetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Greet not implemented")
}
func (UnimplementedGreetServiceServer) GreetManyTimes(*GreetRequeset, GreetService_GreetManyTimesServer) error {
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).Greet(ctx, req.(*GreetRequeset))
	}
...
func (x *greetServiceLongGreetServer) Recv() (*GreetRequeset, error) {
	m := new(GreetRequeset)
...
func (x *greetServiceGreetEveryoneServer) Recv() (*GreetRequeset, error) {
	m := new(GreetRequeset)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
